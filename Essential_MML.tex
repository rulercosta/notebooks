...
% Essential packages for better Pandoc compatibility
...
% For proper handling of Unicode characters
...
\hypersetup{
    ...
    pdffitwindow=false,
    pdfborder={0 0 0},
    pdftitle={Essential Mathematics for Machine Learning: Linear Algebra},
    pdfauthor={Ruler Costa}
}
...
\begin{figure}[h]
\includegraphics[width=\linewidth]{./figures/linear_dependence.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\textwidth]{./figures/linear_independence.png}
...
\bibitem{strang2016introduction} Strang, G. (2016). Introduction to linear algebra (5th ed.). Wellesley-Cambridge Press.
\end{thebibliography}
