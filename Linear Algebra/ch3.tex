...
\begin{figure}[ht]
    \centering
    \includesvg[width=0.8\textwidth]{images/b-vectors-combination.svg}
...
\begin{figure}[ht]
    \centering
    \includesvg[width=1.0\textwidth]{images/b-vector-span.svg}
...
\begin{figure}[ht]
    \centering
    \includesvg[width=0.6\textwidth]{images/b-linear-independence.svg}
